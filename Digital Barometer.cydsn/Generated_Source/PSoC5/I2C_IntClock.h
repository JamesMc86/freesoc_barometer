...
#define I2C_IntClock_SetDivider(clkDivider)         I2C_IntClock_SetDividerRegister(clkDivider, 1)
#define I2C_IntClock_SetDividerValue(clkDivider)    I2C_IntClock_SetDividerRegister((clkDivider) - 1, 1)
...
#define I2C_IntClock_SetPhaseValue(clkPhase)        I2C_IntClock_SetPhaseRegister((clkPhase) + 1)
#endif /* defined(I2C_IntClock__CFG3) */
